$(function() {
    ...
    $('.facebook').on('click', function() {
        var w = 580, h = 300,
            ...
            if ((screen.width < 480) || (screen.height < 480)) {
                window.open ('http://www.facebook.com/share.php?u=http://www.harnessthecrowd.com', '', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=no, copyhistory=no, width='+w+', height='+h+', top='+top+', left='+left);
            } else {
                window.open ('http://www.facebook.com/share.php?u=http://www.harnessthecrowd.com', '', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=no, copyhistory=no, width='+w+', height='+h+', top='+top+', left='+left);   
            }
    });
    ...
    $('.play').on('click', function() {
        window.location.href = "http://www.harnessthecrowd.com/tools/services";
    });
